...
unaryPrimitiveTests = [ (UnaryFnApp "fxadd1" (FixNum 1), "2")
...
binaryPrimitiveTests = [ (BinaryFnApp "fx+" (FixNum 3) (FixNum 1), "4")
                       , (BinaryFnApp "fx+" (FixNum $ -1) (FixNum 1), "0")
                       , (BinaryFnApp "fx+" (BinaryFnApp "fx+" (FixNum 3) (FixNum 5)) (FixNum 2), "10")
                       , (BinaryFnApp "fx+" (BinaryFnApp "fx+" (FixNum 3) (FixNum 5)) (BinaryFnApp "fx+" (FixNum 7) (FixNum 12)), "27")
                       , (BinaryFnApp "fx+" (BinaryFnApp "fx+" (BinaryFnApp "fx+" (FixNum 9) (FixNum 15)) (FixNum 5)) (BinaryFnApp "fx+" (FixNum 7) (FixNum 12)), "48")
                       , (BinaryFnApp "fx-" (FixNum 5) (FixNum 1), "4")
                       , (BinaryFnApp "fxlogand" (FixNum $ -1) (FixNum $ -1), "-1")
                       , (BinaryFnApp "fxlogand" (FixNum 0) (FixNum 1), "0")
                       , (BinaryFnApp "fxlogand" (FixNum 5) (FixNum 3), "1")
                       , (BinaryFnApp "fx=" (FixNum 2) (FixNum 2), "#t")
                       , (BinaryFnApp "fx=" (FixNum 2) (FixNum 5), "#f")
                       , (BinaryFnApp "fx=" (BinaryFnApp "fx+" (FixNum 3) (FixNum 2)) (FixNum 5), "#t")
                       , (BinaryFnApp "fx<" (FixNum 2) (FixNum 2), "#f")
                       , (BinaryFnApp "fx<" (FixNum 2) (FixNum 3), "#t")
                       , (BinaryFnApp "fx<" (FixNum 2) (FixNum 2), "#f")
                       , (BinaryFnApp "fx<" (FixNum $ -2) (FixNum 3), "#t")
                       , (BinaryFnApp "fx<" (FixNum $ -2) (FixNum $ -3), "#f")
                       , (BinaryFnApp "fx<" (FixNum $ -2) (FixNum $ -1), "#t")
                       , (BinaryFnApp "fx<=" (FixNum 2) (FixNum 3), "#t")
                       , (BinaryFnApp "fx<=" (FixNum 2) (FixNum 2), "#t")
                       , (BinaryFnApp "fx<=" (FixNum $ -2) (FixNum 3), "#t")
                       , (BinaryFnApp "fx<=" (FixNum $ -2) (FixNum $ -3), "#f")
                       , (BinaryFnApp "fx<=" (FixNum $ -2) (FixNum $ -1), "#t")
                       , (If (BinaryFnApp "fx<" (FixNum 1) (FixNum 2)) (FixNum 4) (FixNum 7), "4")
                       ]
